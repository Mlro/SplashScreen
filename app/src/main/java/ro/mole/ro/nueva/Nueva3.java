...
import ro.mole.ro.nueva.util.SystemUiHider;
 ...
 * @see SystemUiHider
 */
public class Nueva3 extends SherlockFragmentActivity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nueva3);
        ...
        findViewById(R.id.dummy1).setOnTouchListener(mDelayHideTouchListener);
    ...
    public void splash1(View view) {
        Intent act = new Intent(this,Splash1.class);
    ...
    public void splash2(View view) {
        Intent act = new Intent(this,Splash2.class);

        startActivity(act);

    }

    public void splash3(View view) {
        Intent act = new Intent(this,Splash3.class);
